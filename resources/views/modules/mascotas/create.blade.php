    ...
    <div class="container-fluid mt-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">
                <i class="fas fa-plus text-primary mr-2"></i>Registrar Nueva Mascota
            </h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Datos Clínicos y Propietario</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('mascotas.store') }}" method="POST">
                    ...
                    <div class="card border-left-info shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <div id="dueno_seleccionado_container" class="mt-3 p-3 bg-light border rounded align-items-center justify-content-between" style="display: none;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span id="selected_dueno_name" class="font-weight-bold text-dark h5 mb-0">Carlos Mendoza</span>
                                        <span id="selected_dueno_phone" class="text-muted ml-2">555-0199</span>
                                    </div>
                                </div>
                            ...
                            <input type="hidden" name="dueno_id" id="dueno_id" required value="{{ old('dueno_id') }}">
                            @error('dueno_id')
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" required value="{{ old('nombre') }}" placeholder="Ej. Max">
                            @error('nombre')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control @error('especie') is-invalid @enderror" id="especie" name="especie" required>
                                <option value="" disabled {{ old('especie') ? '' : 'selected' }}>Seleccione una especie</option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('raza') is-invalid @enderror" id="raza" name="raza" required value="{{ old('raza') }}" placeholder="Ej. Golden Retriever">
                            @error('raza')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" required value="{{ old('fecha_nacimiento') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control @error('tipo_sangre') is-invalid @enderror" id="tipo_sangre" name="tipo_sangre" required>
                                <option value="" disabled {{ old('tipo_sangre') ? '' : 'selected' }}>Seleccione el tipo de sangre</option>
                                <option value="DEA 1.1 Positivo" {{ old('tipo_sangre') == 'DEA 1.1 Positivo' ? 'selected' : '' }}>DEA 1.1 Positivo</option>
                                <option value="DEA 1.1 Negativo" {{ old('tipo_sangre') == 'DEA 1.1 Negativo' ? 'selected' : '' }}>DEA 1.1 Negativo</option>
                                <option value="DEA 1.2 Positivo" {{ old('tipo_sangre') == 'DEA 1.2 Positivo' ? 'selected' : '' }}>DEA 1.2 Positivo</option>
                                <option value="A" {{ old('tipo_sangre') == 'A' ? 'selected' : '' }}>A (Felinos)</option>
                                <option value="B" {{ old('tipo_sangre') == 'B' ? 'selected' : '' }}>B (Felinos)</option>
                                <option value="AB" {{ old('tipo_sangre') == 'AB' ? 'selected' : '' }}>AB (Felinos)</option>
                                <option value="Desconocido" {{ old('tipo_sangre') == 'Desconocido' ? 'selected' : '' }}>Desconocido</option>
                            </select>
                            @error('tipo_sangre')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control @error('comportamiento') is-invalid @enderror" id="comportamiento" name="comportamiento" required>
                                <option value="" disabled {{ old('comportamiento') ? '' : 'selected' }}>Seleccione estado de comportamiento</option>
                                <option value="Dócil" {{ old('comportamiento') == 'Dócil' ? 'selected' : '' }}>Dócil</option>
                                <option value="Estable" {{ old('comportamiento') == 'Estable' ? 'selected' : '' }}>Estable</option>
                                <option value="En Tratamiento" {{ old('comportamiento') == 'En Tratamiento' ? 'selected' : '' }}>En Tratamiento</option>
                                ...
                                <option value="Urgente" {{ old('comportamiento') == 'Urgente' ? 'selected' : '' }}>Urgente</option>
                            </select>
